...
The approach is to be very simple by only doing one thing in one component, running fully in the server. If you want a more extensive solution, this might not be for you. Despite this, it consists of only one component to further simplify the experience.
